...
const todos = [
    {
        id: 100,
        title:"เรียนคลาสที่ 1",
        description:"อยากลองเขียนไปเพื่อหาประสบณ์การของตัวเอง",
        cover:"/image/Dead.jpg",
        icon:"/image/omen.jpg",
        enrollment:true,
        checked: true
    },
    {
        id: 200,
        title:"เรียนคลาสที่ 2",
        description:"อยากลองฝึก",
        cover:"/image/LoL.jpg",
        icon:"/image/Dead.jpg",
        enrollment:false,
        checked: true
    ...
    {
        id: 300,
        title:"เรียนคลาสที่ 3",
        description:"อยากทำในสิ่งที่อยากทำ",
        cover:"/image/omen.jpg",
        icon:"/image/LoL.jpg",
        enrollment:false,
        checked: false
    }
  ...
  <div className="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
    <div className="mb-8">
      ...
      <div className="relative h-16 w-16">
                ...
                {like ? (
                    ...
                    <path d="m11.645 20.91-.007-.003-.022-.012a15.247 15.247 0 0 1-.383-.218 25.18 25.18 0 0 1-4.244-3.17C4.688 15.36 2.25 12.174 2.25 8.25 2.25 5.322 4.714 3 7.688 3A5.5 5.5 0 0 1 12 5.052 5.5 5.5 0 0 1 16.313 3c2.973 0 5.437 2.322 5.437 5.25 0 3.925-2.438 7.111-4.739 9.256a25.175 25.175 0 0 1-4.244 3.17 15.247 15.247 0 0 1-.383.219l-.022.012-.007.004-.003.001a.752.752 0 0 1-.704 0l-.003-.001Z " fill="#f87171"/>
                  </svg>
                ) : (
    ...
    <div className="flex items-center">
      ...
      <div className="text-sm">
        <p className="text-gray-900 leading-none">Natthapol</p>
